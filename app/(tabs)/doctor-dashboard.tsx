...
export default function DoctorDashboard() {
  ...
  const fullName = (userInfo?.fullName || 'Doctor') as string;
  const firstName = fullName.trim().split(/\s+/)[0] || 'Doctor';
  ...
  const webQuickActionWidth = Math.max(180, Math.floor((windowWidth - 260 - 80) / 3));

  const renderOverview = () => (
    <>
      {/* Stats Grid - Animations removed for performance */}
      <View style={styles.statsGrid}>
        <View style={[styles.statCard, styles.whiteCard, isDesktopWeb && styles.webKpiCard]}>
          <View style={styles.kpiTopRow}>
            <RNText style={styles.kpiLabel}>Today's Appointments</RNText>
            <MaterialCommunityIcons name="calendar-today" size={20} color="#1E4BA3" />
          </View>
          <RNText style={styles.kpiValue}>{stats.todayAppointments}</RNText>
        </View>

        <View style={[styles.statCard, styles.whiteCard, isDesktopWeb && styles.webKpiCard]}>
          <View style={styles.kpiTopRow}>
            <RNText style={styles.kpiLabel}>Pending Consultations</RNText>
            <Ionicons name="time-outline" size={20} color="#1E4BA3" />
          </View>
          <RNText style={styles.kpiValue}>{stats.pendingAppointments}</RNText>
        </View>

        <View style={[styles.statCard, styles.whiteCard, isDesktopWeb && styles.webKpiCard]}>
          <View style={styles.kpiTopRow}>
            <RNText style={styles.kpiLabel}>Patients</RNText>
            <MaterialCommunityIcons name="account-group" size={20} color="#1E4BA3" />
          </View>
          <RNText style={styles.kpiValue}>{stats.totalPatients}</RNText>
        </View>

        <View style={[styles.statCard, styles.whiteCard, isDesktopWeb && styles.webKpiCard]}>
          <View style={styles.kpiTopRow}>
            <RNText style={styles.kpiLabel}>Prescriptions Issued</RNText>
            <MaterialCommunityIcons name="pill" size={20} color="#1E4BA3" />
          </View>
          <RNText style={styles.kpiValue}>{stats.prescriptionsIssued}</RNText>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.quickActionsGrid}>
          <View>
            <TouchableOpacity
              style={[styles.quickActionCard, isDesktopWeb && { width: webQuickActionWidth }]}
              onPress={() => setActiveTab('appointments')}
            >
              <MaterialCommunityIcons name="calendar-check" size={30} color="#1E4BA3" />
          ...
          <View>
            ...
            >
              <MaterialCommunityIcons name="account-search" size={30} color="#1E4BA3" />
          ...
          <View>
            ...
            >
              <MaterialCommunityIcons name="clipboard-text" size={30} color="#1E4BA3" />
          ...
          <View>
            ...
            >
              <MaterialCommunityIcons name="prescription" size={30} color="#1E4BA3" />
          ...
          <View>
            ...
            >
              <MaterialCommunityIcons name="test-tube" size={30} color="#1E4BA3" />
          ...
          <View>
            ...
            >
              <MaterialCommunityIcons name="message-text" size={30} color="#1E4BA3" />
      ...
      <View style={styles.webRoot}>
          ...
          <View style={styles.webSidebarHeader}>
            <View style={styles.webBrandRow}>
              <View style={styles.webBrandIcon}>
                <RNText style={styles.webBrandIconText}>M</RNText>
              </View>
              <View>
                <RNText style={styles.webBrandName}>MediVault</RNText>
                <RNText style={styles.webBrandRole}>Doctor</RNText>
              </View>
            </View>
          </View>

          <View style={styles.webSidebarSectionHeader}>
            <RNText style={styles.webSidebarSectionTitle}>Navigation</RNText>
          </View>

          <ScrollView style={styles.webSidebarNav} contentContainerStyle={styles.webSidebarNavContent} showsVerticalScrollIndicator={false}>
            <TouchableOpacity style={[styles.webNavItem, activeTab === 'overview' && styles.webNavItemActive]} onPress={() => setActiveTab('overview')}>
              <MaterialCommunityIcons name="view-dashboard" size={20} color="#1F2937" />
              <RNText style={styles.webNavText}>Dashboard</RNText>
            </TouchableOpacity>

            <TouchableOpacity style={[styles.webNavItem, activeTab === 'appointments' && styles.webNavItemActive]} onPress={() => setActiveTab('appointments')}>
              <MaterialCommunityIcons name="calendar-check" size={20} color="#1F2937" />
              <RNText style={styles.webNavText}>Appointments</RNText>
            </TouchableOpacity>

            <TouchableOpacity style={[styles.webNavItem, activeTab === 'patients' && styles.webNavItemActive]} onPress={() => setActiveTab('patients')}>
              <MaterialCommunityIcons name="account-group" size={20} color="#1F2937" />
              <RNText style={styles.webNavText}>Patient Records</RNText>
            </TouchableOpacity>

            <TouchableOpacity style={[styles.webNavItem, activeTab === 'create-medical-record' && styles.webNavItemActive]} onPress={() => setActiveTab('create-medical-record')}>
              <MaterialCommunityIcons name="clipboard-text" size={20} color="#1F2937" />
              <RNText style={styles.webNavText}>Medical Records</RNText>
            </TouchableOpacity>

            <TouchableOpacity style={[styles.webNavItem, activeTab === 'create-prescription' && styles.webNavItemActive]} onPress={() => setActiveTab('create-prescription')}>
              <MaterialCommunityIcons name="prescription" size={20} color="#1F2937" />
              <RNText style={styles.webNavText}>Prescriptions</RNText>
            </TouchableOpacity>

            <TouchableOpacity style={[styles.webNavItem, activeTab === 'order-lab-tests' && styles.webNavItemActive]} onPress={() => setActiveTab('order-lab-tests')}>
              <MaterialCommunityIcons name="test-tube" size={20} color="#1F2937" />
              <RNText style={styles.webNavText}>Lab Tests</RNText>
            </TouchableOpacity>

            <TouchableOpacity style={[styles.webNavItem, activeTab === 'messages' && styles.webNavItemActive]} onPress={() => setActiveTab('messages')}>
              <Ionicons name="chatbubbles-outline" size={20} color="#1F2937" />
              <RNText style={styles.webNavText}>Messages</RNText>
            </TouchableOpacity>

            <TouchableOpacity style={[styles.webNavItem, activeTab === 'notifications' && styles.webNavItemActive]} onPress={() => setActiveTab('notifications')}>
              <Ionicons name="notifications-outline" size={20} color="#1F2937" />
              <RNText style={styles.webNavText}>Notifications</RNText>
            </TouchableOpacity>

            <View style={styles.webSidebarDivider} />

            <TouchableOpacity style={styles.webNavItem} onPress={handleLogout}>
              <Ionicons name="log-out-outline" size={20} color="#1F2937" />
              <RNText style={styles.webNavText}>Logout</RNText>
            </TouchableOpacity>
          </ScrollView>
          ...
          <View style={styles.webSidebarFooter}>
            <View style={styles.webUserRow}>
              <View style={styles.webUserAvatar}>
                <RNText style={styles.webUserAvatarText}>{initials}</RNText>
              </View>
              <View style={styles.webUserText}>
                <RNText style={styles.webUserName}>{fullName}</RNText>
                {userInfo?.email ? <RNText style={styles.webUserEmail}>{String(userInfo.email)}</RNText> : null}
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.webMain}>
          <View style={styles.webTopBar}>
            <View style={{ flex: 1 }} />
            <TouchableOpacity style={styles.webTopBarIconButton} onPress={() => {}}>
          ...
          >
            {activeTab === 'overview' ? (
              <View style={styles.webWelcomeWrap}>
                <RNText style={styles.webWelcomeTitle}>Welcome back, {firstName}!</RNText>
                <RNText style={styles.webWelcomeSubtitle}>Here's what's happening with your healthcare today</RNText>
              </View>
            ) : null}
